    ...
    var class_gpsmap = AbstractAction.extend({
        ...
        events: {
            'click div.vehicle': function (e) {                
                    ...
                    gpsmaps_obj.device_active               =$(this).attr("vehicle");                
		...
		vehicles_menu: function(type)  
		{
            setTimeout(function()
            {
                gpsmaps_obj.render_gps( $("td#menu_vehicle"), $("div#menu_vehicle"), -25);    
        ...
        CreateMap:function(iZoom,iMap,coordinates,object) 
        {
	        ...
	        {  
	            ...
	            {      
			        ...
			        var position		            	=gpsmaps_obj.LatLng(coordinates);
	                    ...
	                    {	                    
	                        ...
	                        {		                
	                            ...
	                            {		                        
                                    ...
                                    var posicion 		=gpsmaps_obj.LatLng(coordinates);
...
//                                    vehiculo["mi"]=position.odometro;
        ...
        positions_search:function(argument){
            ...
            if(gpsmaps_obj.gpsmap_section=="gpsmaps_maphistory")
            {
                ...
                if(gpsmaps_obj.device_active!=0)                
                    option_args["domain"].push(["deviceid","=",gpsmaps_obj.device_active]);
                    ...
                    .then(function (result) 
                    {
                        ...
                        {       
                            ...
                            {                            
                                ...
                                if(gpsmaps_obj.gpsmap_section=="gpsmaps_maphistory")        local.positions[device_id].push(positions);
    ...
    {	    	
        if(gpsmaps_obj.device_active==undefined)    gpsmaps_obj.device_active	=0;        
        ...
        positions: function(argument) {
            ...
            if(gpsmaps_obj.gpsmap_section!="gpsmaps_maphistory" && $("div#maponline").length>0)
            { 
		...
		if(vehicle["st"]=="1" || vehicle["st"]=="-1")
		{
			...
			if(vehicle["ti"] >= localizacion_anterior[device_id]["ti"])
			{
				...
				{				    
					...
					if(gpsmaps_obj.device_active==vehicle["de"] && vehicle["se"]==undefined || vehicle["se"]=="simulator")
					{
					    // SI PASA EN EL HISTORICO
					    //alert("PASA 3");
					    gpsmaps_obj.centerMap(posicion);			
					    gpsmaps_obj.odometro(vehicle);
					} 
				}				
				var marcador 		    = gpsmaps_obj.markerMap(posicion, icon);		
				var infowindow 		    = gpsmaps_obj.messageMap(marcador, vehicle);
				
				gpsmaps_obj.fn_localizaciones(marcador, vehicle);
			}
			else
			{
    ...
    render_gps: function(origen, destino,diferencia)
    {			
	    destino.height(1);
    ...
    centerMap: function(marcador)
	{
        ...
        positions_online: function() {
            ...
            gpsmaps_obj.vehicles_menu(gpsmaps_obj.gpsmap_section);               
            gpsmaps_obj.map();            
...
*/
	...
	messageMaps: function (marcador, vehicle, infowindow) 
	{
	...
	messageMap: function (marcador, vehicle) 
	{
		...
		var infowindow = gpsmaps_obj.map_info({content: contentString});		
		gpsmaps_obj.messageMaps(marcador, vehicle,infowindow);		
	},	
    
	map_info: function (objeto)  
	{
    ...
    local.maponline = class_gpsmap.extend({
        template: 'gpsmaps_maponline',
        start: function() {                  
            gpsmaps_obj.gpsmap_section="gpsmaps_maponline"; 
