odoo.define('gpsmap.base', function (require) {
    "use strict";
...
odoo.define('gpsmap.maponline', function (require) {
    "use strict";
    var gpsmap_base  		=require('gpsmap.base');

    var maponline = gpsmap_base.extend({
    ...
    core.action_registry.add('gpsmap.maponline',maponline);
...
odoo.define('gpsmap.streetonline', function (require) {
    "use strict";
    var gpsmap_base  		=require('gpsmap.base');

    var streetonline = gpsmap_base.extend({
    ...
    core.action_registry.add('gpsmap.streetonline', streetonline);
...
odoo.define('gpsmap.maphistory', function (require) {
    "use strict";
    var gpsmap_base  		=require('gpsmap.base');

    var maphistory = gpsmap_base.extend({
        template: 'gpsmaps_maponline',
    ...
    core.action_registry.add('gpsmap.streetonline', maphistory);
